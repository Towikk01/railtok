	...
	return (
		<section id="features" className="flex flex-col w-full px-5 py-10 border-black border-b">
			<div className="flex flex-col items-center gap-10">
				<h4 className="text-[40px] text-white leading-10 relative before:absolute before:top-1/2 md:before:w-1/5 before:h-0.5 before:bg-black md:before:content-[''] before:-left-[25%] after:absolute w-fit after:top-1/2 md:after:w-1/5 after:h-0.5 after:bg-black md:after:content-[''] after:-right-[25%] text-center">{currentTranslations.features.title}</h4>
