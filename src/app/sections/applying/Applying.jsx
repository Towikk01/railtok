...
const Applying = () => {
	...
	return (
		<section id="contact" className="flex flex-col w-full px-5 py-10 gap-5 border-black border-b">
			<h3 className="text-[35px] text-center relative text-white after:absolute w-fit after:w-full after:h-0.5 after:bg-black after:content-[''] after:-bottom-0 after:left-0">{currentTranslations.apply.title}</h3>
