...
const AboutSection = () => {
	...
	const data = [currentTranslations.about.p1, currentTranslations.about.p2, currentTranslations.about.p3, currentTranslations.about.p4];
	return (
		<section id="about" className="flex md:flex-row w-full px-5 py-10 border-black border-b">
			<div className="w-full flex flex-col md:flex-row items-center justify-between gap-8">
				<div className="text-white md:w-2/4 w-full flex flex-col gap-5 items-center md:items-start">
					...
					{data.map((item, index) => (
						<ApplyBlock key={index} description={item} className="text-[20px] text-white leading-8 text-center"/>
					))}
				</div>
