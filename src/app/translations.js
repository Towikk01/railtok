...
export const translations = {
         ru: {
             ...
             title: 'Немного о нас',
                 ...
                 p3: 'Мы проводим полное сопровождение как на этапе подбора, так и на протяжении всего периода трудовой деятельности. Наши координаторы вас никогда не бросят.'
             },
             contacts: {
...
['Document processing', 'Polish work visa', 'Student certificate', 'Paragraph 24 in Germany', 'Registration, tax number, insurance, and bank account']]
    ...
    uk:{
        ...
        review: {
            ...
            description: 'Прочитайте відгуки клієнтів, які вже співпрацювали з нами. Можливо вони надихнуть Вас звернутися за трудовим устройством саме в нашу компанію. Ми з свого боку допоможемо Вам з трудовим устройством, житлом і документами максимально швидко і якісно!',
            reviews: [
