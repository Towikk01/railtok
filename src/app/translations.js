...
export const translations = {
	ru: {
		...
		heading: {
			title: 'Railtok Recruitment это компания по подбору персонала, которая предоставляет работу в Польше и странах Западной Европы.',
	...
	uk:{
		...
		heading: {
			title: 'Railtok Recruitment це компанія по підбору персоналу, яка надає роботу в Польщі та країнах Західної Європи.',
